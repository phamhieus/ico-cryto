...
NioApp = function (NioApp, $, window, document) {
    ...
    NioApp.Plugins.countdown = function () {
        ...
        $(this).html('<div class="countdown-item"><span class="countdown-time countdown-time-first">%D</span><span class="countdown-text">' + '00' + '</span></div>' + '<div class="countdown-item"><span class="countdown-time">%H</span><span class="countdown-text">' + '00' + '</span></div>' + '<div class="countdown-item"><span class="countdown-time">%M</span><span class="countdown-text">' + '00' + '</span></div>' + '<div class="countdown-item"><span class="countdown-time countdown-time-last">%S</span><span class="countdown-text">' + '00' + '</span></div>');
        ...
        if ($count.exists()) {
            $count.each(function () {
                ...
                //Set default view for count down
                $('.countdown').html('<div class="countdown-item"><span class="countdown-time countdown-time-first">00</span><span class="countdown-text">'
                    + _day_text + '</span></div>' + '<div class="countdown-item"><span class="countdown-time">00</span><span class="countdown-text">'
                    + _hour_text + '</span></div>' + '<div class="countdown-item"><span class="countdown-time">00</span><span class="countdown-text">'
                    + _min_text + '</span></div>' + '<div class="countdown-item"><span class="countdown-time countdown-time-last">00</span><span class="countdown-text">'
                    + _sec_text + '</span></div>');
        ...
        //  $('.countdown').html('<div class="countdown-item"><span class="countdown-time countdown-time-first">%D</span><span class="countdown-text">' + '00' + '</span></div>' + '<div class="countdown-item"><span class="countdown-time">%H</span><span class="countdown-text">' + '00' + '</span></div>' + '<div class="countdown-item"><span class="countdown-time">%M</span><span class="countdown-text">' + '00' + '</span></div>' + '<div class="countdown-item"><span class="countdown-time countdown-time-last">%S</span><span class="countdown-text">' + '00' + '</span></div>');
